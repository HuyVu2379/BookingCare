                ...
                <div className="home-header-container">
                    <div className="home-header-content">
                        ...
                        <div className="right-content">
                            ...
                            <div className={language === LANGUAGES.EN ? 'language-vi' : 'language-vi active'}><span onClick={() => this.changeLanguage(LANGUAGES.VI)}>VN</span></div>
                    ...
                    <div className="home-header-banner">
                        <div className="content-up">
                            ...
                            <div className='search'>
                                ...
                                <input type="text" placeholder='Tìm anh huy vũ' />
                            </div>
                        </div>
                        <div className="content-down">
                            <div className='options'>
                                ...
                                <div className="option-child">
                                    <div className="icon-child"><i class="fas fa-user-graduate"></i></div>
